"""
Weight optimizer for the Tennis Composite Win% Model (WTA).
...
def eval_weights(w, arrays, mask=None):
    """Return (brier, accuracy) for a weight vector [wr, we, wse, wrank, wace, wss]."""
    ...
    # WTA is best-of-3 only — no Bo5 adjustment
...
def main():
    ...
    print(f"  {len(df):,} WTA matches loaded.\n")
    ...
    print()
    print("Suggested SURFACE_WEIGHTS for wta/backtest.py and wta/live.py:")
